...
default.stun.group                 = node.install.user.empty? ? "stun" : node.install.user
default.stun.user                  = node.install.user.empty? ? "stun" : node.install.user
...
default.stun.dir                   = node.install.dir.empty? ? "/usr/local" : node.install.dir
